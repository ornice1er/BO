...
var parser = {
  ...
  parse: /* @__PURE__ */ __name((text) => __async(null, null, function* () {
    try {
      const parseFunc = parse;
      const ast = yield parseFunc("treemap", text);
...
//# sourceMappingURL=chunk-P446J4SV.js.map
