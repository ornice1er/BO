...
var parser = function() {
  ...
  var parser2 = {
    ...
    table: [{
      ...
      7: $Va,
      11: $Vb
    }), o($Vc, [2, 8]), o($Vc, [2, 9]), o($Vc, [2, 10]), o($V8, [2, 15]), o($V9, [2, 13], {
      7: $Va,
      11: $Vb
    }), o($Vc, [2, 11]), o($Vc, [2, 12])],
    defaultActions: {
...
var draw = /* @__PURE__ */ __name((_text, id, _version, diagram2) => {
  ...
  for (let p = 0; p < pairCount; p++) {
    ...
    for (const [cause, dir, len] of [[causes[p * 2], -1, upperLen], [causes[p * 2 + 1], 1, lowerLen]]) {
      if (cause) {
...
var drawBranch = /* @__PURE__ */ __name((svg, node, startX, startY, direction, length, fontSize, roughContext) => {
  ...
  const {
    entries,
    yOrder
  } = flattenTree(children, direction);
...
//# sourceMappingURL=chunk-EBBHQF2N.js.map
