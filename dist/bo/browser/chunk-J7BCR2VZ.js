...
var getConfig3 = /* @__PURE__ */ __name(() => {
  const config = cleanAndMerge(__spreadValues(__spreadValues({}, DEFAULT_GITGRAPH_CONFIG), getConfig().gitGraph));
  return config;
}, "getConfig");
...
var parser = {
  parse: /* @__PURE__ */ __name((input) => __async(null, null, function* () {
    const ast = yield parse("gitGraph", input);
    log.debug(ast);
    populate(ast, db);
  }), "parse")
};
...
var NEO_COLOR_GEN_THEMES = /* @__PURE__ */ new Set(["redux", "redux-dark", "redux-color", "redux-dark-color", "neo", "neo-dark"]);
...
//# sourceMappingURL=chunk-J7BCR2VZ.js.map
