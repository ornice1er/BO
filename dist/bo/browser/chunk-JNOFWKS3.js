...
var parser = function() {
  ...
  var parser2 = {
    ...
    table: [{
      ...
      15: 30,
      24: $Vc
    }), o($Vb, [2, 22]), o($Vb, [2, 23]), o($Vd, [2, 25]), o($Vd, [2, 26]), o($Vd, [2, 28], {
      20: [1, 32]
    }), {
      21: [1, 33]
    }, {
      ...
      7: $Vf,
      11: $Vg
    }), o($Vh, [2, 8]), o($Vh, [2, 9]), o($Vh, [2, 10]), o($Vb, [2, 16], {
      15: 37,
      24: $Vc
    }), o($Vb, [2, 17]), o($Vb, [2, 18]), o($Vb, [2, 20], {
      24: $Vi
    }), o($Vd, [2, 31]), {
      21: [1, 39]
    }, {
...
var draw = /* @__PURE__ */ __name((text, id, _version, diagObj) => __async(null, null, function* () {
  ...
  for (const section of sections2) {
    ...
    const sectionObj = yield insertCluster(sectionsElem, section);
  ...
  for (const section of sections2) {
    ...
    for (const item of sectionItems) {
      ...
      const nodeEl = yield insertNode(nodesElem, item, {
        config: conf
      });
      const bbox = nodeEl.node().getBBox();
      item.y = y + bbox.height / 2;
      yield positionNode(item);
...
//# sourceMappingURL=chunk-JNOFWKS3.js.map
