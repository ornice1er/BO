    ...
    !function(t, s) {
      ...
      var t, s, n = 1e3, i = 6e4, e = 36e5, r = 864e5, o = /\[([^\]]+)]|Y{1,4}|M{1,4}|D{1,2}|d{1,4}|H{1,2}|h{1,2}|a|A|m{1,2}|s{1,2}|Z{1,2}|SSS/g, u = 31536e6, d = 2628e6, a = /^(-|\+)?P(?:([-+]?[0-9,.]*)Y)?(?:([-+]?[0-9,.]*)M)?(?:([-+]?[0-9,.]*)W)?(?:([-+]?[0-9,.]*)D)?(?:T(?:([-+]?[0-9,.]*)H)?(?:([-+]?[0-9,.]*)M)?(?:([-+]?[0-9,.]*)S)?)?$/, h = {
        ...
        return y2.calMilliseconds = function() {
          ...
          var n2 = t2 || "YYYY-MM-DDTHH:mm:ss", i2 = {
            Y: this.$d.years,
  ...
  const compileTask = /* @__PURE__ */ __name(function(pos) {
    ...
    if (rawTasks[pos].startTime) {
      ...
      if (rawTasks[pos].endTime) {
        ...
        rawTasks[pos].manualEndTime = (0, import_dayjs.default)(rawTasks[pos].raw.endTime.data, "YYYY-MM-DD", true).isValid();
...
var draw = /* @__PURE__ */ __name(function(text, id, version, diagObj) {
  ...
  function getEstimatedTickCount(minTime, maxTime, every, interval) {
    ...
    const intervalMs = import_dayjs2.default.duration({
      [interval ?? "day"]: every
    }).asMilliseconds();
    if (intervalMs <= 0) {
      return Infinity;
...
//# sourceMappingURL=chunk-3IFOSLFB.js.map
