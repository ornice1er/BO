import {
  Graph
} from "./chunk-XR3AAELT.js";
import {
  clone_default
} from "./chunk-ZUF735ZP.js";
import "./chunk-ILT6OF2W.js";
import "./chunk-OBVX5ZNT.js";
import {
  getIconStyles
} from "./chunk-FYNH5L47.js";
import {
  computeLabelTransform,
  getLineFunctionsWithOffset
} from "./chunk-LHBXSW5D.js";
import {
    ...
    performAction: /* @__PURE__ */ __name(function anonymous(yytext, yyleng, yylineno, yy, yystate, $$, _$) {
      ...
      switch (yystate) {
        ...
        case 27:
          ...
          this.$ = __spreadProps(__spreadValues({}, $$[$0 - 2]), {
            type: "composite",
            children: $$[$0 - 1]
          });
          break;
  ...
  block.children.length > 0) {
    ...
    const rowHeights = /* @__PURE__ */ new Map();
    {
      ...
      for (const child of block.children) {
        ...
        const {
          py
        } = calculateBlockPosition(columns, colPos);
...
var edgeLabels = {};
var terminalLabels = {};
var insertEdgeLabel = /* @__PURE__ */ __name((elem, edge) => __async(null, null, function* () {
  const config2 = getConfig2();
  const useHtmlLabels = getEffectiveHtmlLabels(config2);
  const edgeLabel = elem.insert("g").attr("class", "edgeLabel");
  const label = edgeLabel.insert("g").attr("class", "label");
  const isMarkdown = edge.labelType === "markdown";
  const labelElement = yield createText(elem, edge.label, {
  ...
  if (edge.startLabelLeft) {
    ...
    const startLabelElement = yield createLabel_default(inner, edge.startLabelLeft, edge.labelStyle);
  ...
  if (edge.startLabelRight) {
    ...
    const startLabelElement = yield createLabel_default(startEdgeLabelRight, edge.startLabelRight, edge.labelStyle);
    fo = startLabelElement;
  ...
  if (edge.endLabelLeft) {
    ...
    const endLabelElement = yield createLabel_default(inner, edge.endLabelLeft, edge.labelStyle);
    fo = endLabelElement;
  ...
  if (edge.endLabelRight) {
    ...
    const endLabelElement = yield createLabel_default(inner, edge.endLabelRight, edge.labelStyle);
    fo = endLabelElement;
    let slBox = endLabelElement.getBBox();
    if (useHtmlLabels) {
      const div = endLabelElement.children[0];
...
var labelHelper = /* @__PURE__ */ __name((parent, node, _classes, isNode) => __async(null, null, function* () {
  const config2 = getConfig2();
  let classes2;
  ...
  if (node.labelType === "markdown") {
    ...
    text = yield createLabel_default(label, sanitizeText(decodeEntities(labelText), config2), node.labelStyle, false, isNode);
  }
  ...
  if (getEffectiveHtmlLabels(config2)) {
    ...
    yield configureLabelImages(div, labelText);
    bbox = div.getBoundingClientRect();
    dv.attr("width", bbox.width);
    dv.attr("height", bbox.height);
  }
...
var note = /* @__PURE__ */ __name((parent, node) => __async(null, null, function* () {
...
var question = /* @__PURE__ */ __name((parent, node) => __async(null, null, function* () {
  const {
    shapeSvg,
    bbox
...
var hexagon = /* @__PURE__ */ __name((parent, node) => __async(null, null, function* () {
  const {
    shapeSvg,
    bbox
  } = yield labelHelper(parent, node, getClassesFromNode(node, void 0), true);
...
var block_arrow = /* @__PURE__ */ __name((parent, node) => __async(null, null, function* () {
  const {
    shapeSvg,
    bbox
  } = yield labelHelper(parent, node, void 0, true);
  const f = 2;
...
var rect_left_inv_arrow = /* @__PURE__ */ __name((parent, node) => __async(null, null, function* () {
  const {
    shapeSvg,
    bbox
  } = yield labelHelper(parent, node, getClassesFromNode(node, void 0), true);
...
var lean_right = /* @__PURE__ */ __name((parent, node) => __async(null, null, function* () {
  const {
    shapeSvg,
    bbox
...
var lean_left = /* @__PURE__ */ __name((parent, node) => __async(null, null, function* () {
  const {
    shapeSvg,
    bbox
  } = yield labelHelper(parent, node, getClassesFromNode(node, void 0), true);
...
var trapezoid = /* @__PURE__ */ __name((parent, node) => __async(null, null, function* () {
  const {
    shapeSvg,
    bbox
  } = yield labelHelper(parent, node, getClassesFromNode(node, void 0), true);
...
var inv_trapezoid = /* @__PURE__ */ __name((parent, node) => __async(null, null, function* () {
  const {
    shapeSvg,
    bbox
  } = yield labelHelper(parent, node, getClassesFromNode(node, void 0), true);
...
var rect_right_inv_arrow = /* @__PURE__ */ __name((parent, node) => __async(null, null, function* () {
  const {
    shapeSvg,
    bbox
  } = yield labelHelper(parent, node, getClassesFromNode(node, void 0), true);
...
var cylinder = /* @__PURE__ */ __name((parent, node) => __async(null, null, function* () {
  const {
    shapeSvg,
    bbox
  } = yield labelHelper(parent, node, getClassesFromNode(node, void 0), true);
...
var composite = /* @__PURE__ */ __name((parent, node) => __async(null, null, function* () {
  const {
    shapeSvg,
    bbox,
    halfPadding
...
var labelRect = /* @__PURE__ */ __name((parent, node) => __async(null, null, function* () {
  const {
    shapeSvg
...
var rectWithTitle = /* @__PURE__ */ __name((parent, node) => __async(null, null, function* () {
  let classes2;
  if (!node.classes) {
    classes2 = "node default";
  } else {
  ...
  const text = yield createLabel_default(label, title, node.labelStyle, true, true);
  let bbox = {
    width: 0,
    height: 0
  };
  ...
  const descr = yield createLabel_default(label, textRows.join ? textRows.join("<br/>") : textRows, node.labelStyle, true, true);
  if (getEffectiveHtmlLabels(getConfig2())) {
  ...
  const halfPadding = node.padding / 2;
  select_default(descr).attr("transform", "translate( " + // (titleBox.width - bbox.width) / 2 +
  (bbox.width > titleBox.width ? 0 : (titleBox.width - bbox.width) / 2) + ", " + (titleBox.height + halfPadding + 5) + ")");
  select_default(text).attr("transform", "translate( " + // (titleBox.width - bbox.width) / 2 +
...
var stadium = /* @__PURE__ */ __name((parent, node) => __async(null, null, function* () {
  const {
    shapeSvg,
    bbox
  } = yield labelHelper(parent, node, getClassesFromNode(node, void 0), true);
...
var circle2 = /* @__PURE__ */ __name((parent, node) => __async(null, null, function* () {
  const {
    shapeSvg,
    bbox,
    halfPadding
...
var doublecircle = /* @__PURE__ */ __name((parent, node) => __async(null, null, function* () {
  const {
    shapeSvg,
    bbox,
    halfPadding
...
var subroutine = /* @__PURE__ */ __name((parent, node) => __async(null, null, function* () {
  const {
    shapeSvg,
    bbox
  } = yield labelHelper(parent, node, getClassesFromNode(node, void 0), true);
...
var class_box = /* @__PURE__ */ __name((parent, node) => __async(null, null, function* () {
  const halfPadding = node.padding / 2;
  const rowPadding = 4;
  const lineHeight = 8;
  let classes2;
  ...
  const interfaceLabel = yield createLabel_default(labelContainer, interfaceLabelText, node.labelStyle, true, true);
  ...
  const classTitleLabel = yield createLabel_default(labelContainer, classTitleString, node.labelStyle, true, true);
  ...
  node.classData.members.forEach((member) => __async(null, null, function* () {
    const parsedInfo = member.getDisplayDetails();
    let parsedText = parsedInfo.displayText;
    if (getEffectiveHtmlLabels(getConfig2())) {
      parsedText = parsedText.replace(/</g, "&lt;").replace(/>/g, "&gt;");
    }
    const lbl = yield createLabel_default(labelContainer, parsedText, parsedInfo.cssStyle ? parsedInfo.cssStyle : node.labelStyle, true, true);
  ...
  const classMethods = [];
  node.classData.methods.forEach((member) => __async(null, null, function* () {
    const parsedInfo = member.getDisplayDetails();
    let displayText = parsedInfo.displayText;
    if (getEffectiveHtmlLabels(getConfig2())) {
      displayText = displayText.replace(/</g, "&lt;").replace(/>/g, "&gt;");
    }
    const lbl = yield createLabel_default(labelContainer, displayText, parsedInfo.cssStyle ? parsedInfo.cssStyle : node.labelStyle, true, true);
    let bbox = lbl.getBBox();
    if (getEffectiveHtmlLabels(getConfig2())) {
      const div = lbl.children[0];
      const dv = select_default(lbl);
...
var nodeElems = {};
var insertNode = /* @__PURE__ */ __name((elem, node, renderOptions) => __async(null, null, function* () {
  let newEl;
  let el;
  if (node.link) {
    let target;
    ...
    el = yield shapes[node.shape](newEl, node, renderOptions);
  } else {
    el = yield shapes[node.shape](elem, node, renderOptions);
    newEl = el;
  }
  if (node.tooltip) {
...
function calculateBlockSize(elem, block, db2) {
  return __async(this, null, function* () {
    ...
    const nodeEl = yield insertNode(elem, node, {
      config: config2
    });
...
function insertBlockPositioned(elem, block, db2) {
  return __async(this, null, function* () {
    const node = getNodeFromBlock(block, db2, true);
    const obj = db2.getBlock(node.id);
    if (obj.type !== "space") {
      const config2 = getConfig();
      yield insertNode(elem, node, {
        config: config2
      });
...
function performOperations(elem, blocks2, db2, operation) {
  return __async(this, null, function* () {
    for (const block of blocks2) {
      yield operation(elem, block, db2);
      if (block.children) {
        yield performOperations(elem, block.children, db2, operation);
      }
    }
  });
}
__name(performOperations, "performOperations");
function calculateBlockSizes(elem, blocks2, db2) {
  return __async(this, null, function* () {
    yield performOperations(elem, blocks2, db2, calculateBlockSize);
  });
}
__name(calculateBlockSizes, "calculateBlockSizes");
function insertBlocks(elem, blocks2, db2) {
  return __async(this, null, function* () {
    yield performOperations(elem, blocks2, db2, insertBlockPositioned);
  });
}
__name(insertBlocks, "insertBlocks");
function insertEdges(elem, edges, blocks2, db2, id) {
  return __async(this, null, function* () {
    const g = new Graph({
      multigraph: true,
      compound: true
    ...
    for (const edge of edges) {
      if (edge.start && edge.end) {
        ...
        if (startBlock?.size && endBlock?.size) {
          ...
          if (edge.label) {
            yield insertEdgeLabel(elem, __spreadProps(__spreadValues({}, edge), {
              label: edge.label,
            ...
            positionEdgeLabel(__spreadProps(__spreadValues({}, edge), {
              x: points[1].x,
              y: points[1].y
            }), {
              originalPath: points
...
var draw = /* @__PURE__ */ __name(function(text, id, _version, diagObj) {
  return __async(this, null, function* () {
    ...
    yield calculateBlockSizes(nodes, bl, db2);
    const bounds = layout(db2);
    yield insertBlocks(nodes, bl, db2);
    yield insertEdges(nodes, edges, blArr, db2, id);
    if (bounds) {
...
//# sourceMappingURL=chunk-PI7I4L7P.js.map
