...
} from "./chunk-RKBKKJJF.mjs";
import {
  at
} from "./chunk-RLM5XYOU.mjs";
import {
  compileStyles,
  solidStateFill,
  styles2String,
  userNodeOverrides
} from "./chunk-26S4CCAA.mjs";
import {
  createText,
  getIconSVG
} from "./chunk-XXV2XYBW.mjs";
import {
  calculateTextWidth,
  decodeEntities,
  handleUndefinedAttr
...
var labelHelper = /* @__PURE__ */ __name((parent, node, _classes) => __async(null, null, function* () {
  let cssClasses;
  ...
  const text2 = yield createText(labelEl, sanitizeText(decodeEntities(label), getConfig2()), {
    useHtmlLabels,
  ...
  if (useHtmlLabels) {
    ...
    yield configureLabelImages(div, label);
...
var insertLabel = /* @__PURE__ */ __name((parent, label, options) => __async(null, null, function* () {
...
var createLabel = /* @__PURE__ */ __name((element, _vertexText, style, isTitle = false, isNode = false) => __async(null, null, function* () {
  ...
  return yield createText(element, vertexText, {
    style,
    isTitle,
    useHtmlLabels,
    markdown: false,
...
var rect = /* @__PURE__ */ __name((parent, node) => __async(null, null, function* () {
  ...
  if (node.labelType === "markdown") {
    text2 = yield createText(labelEl, node.label, {
      style: node.labelStyle,
      useHtmlLabels,
      isNode: true,
      width: node.width
    ...
    text2 = yield createLabel_default(labelEl, node.label, node.labelStyle || "", false, true);
  }
  let bbox = text2.getBBox();
...
var roundedWithTitle = /* @__PURE__ */ __name((parent, node) => __async(null, null, function* () {
  const siteConfig = getConfig2();
  const {
    themeVariables,
    handDrawnSeed
  ...
  const text2 = yield createLabel_default(label, node.label, node.labelStyle, void 0, true);
  let bbox = text2.getBBox();
  if (getEffectiveHtmlLabels(siteConfig)) {
    const div = text2.children[0];
    const dv = select_default(text2);
...
var kanbanSection = /* @__PURE__ */ __name((parent, node) => __async(null, null, function* () {
  log.info("Creating subgraph rect for ", node.id, node);
  const siteConfig = getConfig2();
  const {
    themeVariables,
  ...
  const useHtmlLabels = getEffectiveHtmlLabels(siteConfig);
  const labelEl = shapeSvg.insert("g").attr("class", "cluster-label ");
  const text2 = yield createText(labelEl, node.label, {
    style: node.labelStyle,
    useHtmlLabels,
    isNode: true,
    width: node.width
...
var insertCluster = /* @__PURE__ */ __name((elem, node) => __async(null, null, function* () {
  const shape = node.shape || "rect";
  const cluster = yield shapes[shape](elem, node);
...
function bowTieRect(parent, node) {
  return __async(this, null, function* () {
    ...
    const {
      shapeSvg,
      bbox
    } = yield labelHelper(parent, node, getNodeClasses(node));
...
function circle(parent, node, options) {
  return __async(this, null, function* () {
    const {
      labelStyles,
      nodeStyles
...
function curlyBraceLeft(parent, node) {
  return __async(this, null, function* () {
    const {
      labelStyles,
      nodeStyles
...
function curlyBraceRight(parent, node) {
  return __async(this, null, function* () {
    const {
      labelStyles,
      nodeStyles
...
function curlyBraces(parent, node) {
  return __async(this, null, function* () {
    const {
      labelStyles,
      nodeStyles
...
function curvedTrapezoid(parent, node) {
  return __async(this, null, function* () {
    const {
      labelStyles,
      nodeStyles
...
function dividedRectangle(parent, node) {
  return __async(this, null, function* () {
    const {
      labelStyles,
      nodeStyles
...
function doublecircle(parent, node) {
  return __async(this, null, function* () {
    const {
      labelStyles,
      nodeStyles
...
var MIN_HEIGHT2 = 10;
var MIN_WIDTH2 = 10;
function flippedTriangle(parent, node) {
  return __async(this, null, function* () {
    const {
      labelStyles,
      nodeStyles
...
function halfRoundedRectangle(parent, node) {
  return __async(this, null, function* () {
    const {
      labelStyles,
      nodeStyles
...
function hourglass(parent, node) {
  return __async(this, null, function* () {
    const {
      labelStyles,
      nodeStyles
...
function icon(_0, _1, _2) {
  return __async(this, arguments, function* (parent, node, {
    config: {
      themeVariables,
      flowchart
    }
    ...
    const {
      ...
      bbox,
      label
    } = yield labelHelper(parent, node, "icon-shape default");
    ...
    if (node.icon) {
      ...
      iconElem.html(`<g>${yield getIconSVG(node.icon, {
        height: iconSize,
        width: iconSize,
        fallbackPrefix: ""
      })}</g>`);
...
function imageSquare(_0, _1, _2) {
  return __async(this, arguments, function* (parent, node, {
    ...
    const {
      ...
      bbox,
      label
    } = yield labelHelper(parent, node, "image-shape default");
    const topLabel = node.pos === "t";
...
function inv_trapezoid(parent, node) {
  return __async(this, null, function* () {
    const {
      labelStyles,
      nodeStyles
...
function drawRect(parent, node, options) {
  return __async(this, null, function* () {
    const {
      labelStyles,
      nodeStyles
...
function labelRect(parent, node) {
  return __async(this, null, function* () {
    const {
      shapeSvg,
      bbox,
      label
    } = yield labelHelper(parent, node, "label");
    const rect2 = shapeSvg.insert("rect", ":first-child");
...
function lean_left(parent, node) {
  return __async(this, null, function* () {
    const {
      labelStyles,
      nodeStyles
...
function lean_right(parent, node) {
  return __async(this, null, function* () {
    const {
      labelStyles,
      nodeStyles
...
var MIN_HEIGHT3 = 10;
var MIN_WIDTH3 = 10;
function linedCylinder(parent, node) {
  return __async(this, null, function* () {
    const {
      labelStyles,
      nodeStyles
...
function linedWaveEdgedRect(parent, node) {
  return __async(this, null, function* () {
    const {
      labelStyles,
      nodeStyles
...
function multiRect(parent, node) {
  return __async(this, null, function* () {
    const {
      labelStyles,
      nodeStyles
...
function multiWaveEdgedRectangle(parent, node) {
  return __async(this, null, function* () {
    const {
      labelStyles,
      nodeStyles
...
function rect_left_inv_arrow(parent, node) {
  return __async(this, null, function* () {
    const {
      labelStyles,
      nodeStyles
...
function rectWithTitle(parent, node) {
  return __async(this, null, function* () {
    const {
      labelStyles,
      nodeStyles
    ...
    const text2 = yield createLabel_default(label, title, node.labelStyle, true, true);
    let bbox = {
      width: 0,
      height: 0
    };
    ...
    const descr = yield createLabel_default(label, Array.isArray(textRows) ? textRows.join("<br/>") : textRows, node.labelStyle, true, true);
...
var FRAME_WIDTH = 8;
function shadedProcess(parent, node) {
  return __async(this, null, function* () {
    const {
      labelStyles,
      nodeStyles
...
function slopedRect(parent, node) {
  return __async(this, null, function* () {
    const {
      labelStyles,
      nodeStyles
...
function squareRect2(parent, node) {
  return __async(this, null, function* () {
    const nodePadding = node.padding ?? 0;
...
function stateEnd(parent, node, {
  ...
  const roughNode = rc.circle(0, 0, node.width, __spreadProps(__spreadValues({}, options), {
    stroke: lineColor,
    strokeWidth: 2
  }));
  const innerFill = stateBorder ?? nodeBorder;
  const innerNodeRadius = (node.width ?? 0) * 5 / 14;
  const roughInnerNode = rc.circle(0, 0, innerNodeRadius, __spreadProps(__spreadValues({}, options), {
    fill: innerFill,
    stroke: innerFill,
    strokeWidth: 2,
    fillStyle: "solid"
...
var FRAME_WIDTH2 = 8;
function subroutine(parent, node) {
  return __async(this, null, function* () {
    const {
      labelStyles,
      nodeStyles
...
var TAG_RATIO = 0.2;
function taggedRect(parent, node) {
  return __async(this, null, function* () {
    const {
      labelStyles,
      nodeStyles
    ...
    const tagNode = rc.path(tagPath, __spreadProps(__spreadValues({}, options), {
      fillStyle: "solid"
    }));
...
function taggedWaveEdgedRectangle(parent, node) {
  return __async(this, null, function* () {
    const {
      labelStyles,
      nodeStyles
...
var MIN_HEIGHT4 = 5;
var MIN_WIDTH4 = 10;
function tiltedCylinder(parent, node) {
  return __async(this, null, function* () {
    const {
      labelStyles,
      nodeStyles
...
function trapezoid(parent, node) {
  return __async(this, null, function* () {
    const {
      labelStyles,
      nodeStyles
...
function trapezoidalPentagon(parent, node) {
  return __async(this, null, function* () {
    const {
      labelStyles,
      nodeStyles
...
function waveEdgedRectangle(parent, node) {
  return __async(this, null, function* () {
    const {
      labelStyles,
      nodeStyles
...
function waveRectangle(parent, node) {
  return __async(this, null, function* () {
    const {
      labelStyles,
      nodeStyles
...
var rectOffset = 10;
function windowPane(parent, node) {
  return __async(this, null, function* () {
    const {
      labelStyles,
      nodeStyles
...
function erBox(parent, node) {
  return __async(this, null, function* () {
    ...
    if (node.look === "handDrawn") {
      ...
      yield erBox(parent, backgroundNode);
    }
    ...
    if (entityNode.attributes.length === 0 && node.label) {
      ...
      const shapeSvg2 = yield drawRect(parent, node, options2);
    ...
    const shapeSvg = parent.insert("g").attr("class", cssClasses).attr("id", node.domId || node.id);
    const nameBBox = yield addText(shapeSvg, node.label ?? "", config, 0, 0, ["name"], labelStyles);
    ...
    for (const attribute of entityNode.attributes) {
      const typeBBox = yield addText(shapeSvg, attribute.type, config, 0, yOffset, ["attribute-type"], labelStyles);
      maxTypeWidth = Math.max(maxTypeWidth, typeBBox.width + PADDING);
      const nameBBox2 = yield addText(shapeSvg, attribute.name, config, 0, yOffset, ["attribute-name"], labelStyles);
      maxNameWidth = Math.max(maxNameWidth, nameBBox2.width + PADDING);
      const keysBBox = yield addText(shapeSvg, attribute.keys.join(), config, 0, yOffset, ["attribute-keys"], labelStyles);
      maxKeysWidth = Math.max(maxKeysWidth, keysBBox.width + PADDING);
      const commentBBox = yield addText(shapeSvg, attribute.comment, config, 0, yOffset, ["attribute-comment"], labelStyles);
    ...
    for (const [i, row] of rows.entries()) {
      ...
      const roughRect2 = rc.rectangle(x, nameBBox.height + y + row?.yOffset, w, row?.rowHeight, __spreadProps(__spreadValues({}, options), {
...
__name(erBox, "erBox");
function addText(_0, _1, _2) {
  return __async(this, arguments, function* (shapeSvg, labelText, config, translateX = 0, translateY = 0, classes = [], style = "") {
    ...
    const text2 = label.node().appendChild(yield createText(label, labelText, {
...
function textHelper(_0, _1, _2, _3) {
  return __async(this, arguments, function* (parent, node, config, useHtmlLabels, GAP = config.class.padding ?? 12) {
    ...
    if (node.annotations.length > 0) {
      ...
      yield addText2(annotationGroup, {
    ...
    yield addText2(labelGroup, node, 0, ["font-weight: bolder"]);
    const labelGroupBBox = labelGroup.node().getBBox();
    labelGroupHeight = labelGroupBBox.height;
    membersGroup = shapeSvg.insert("g").attr("class", "members-group text");
    let yOffset = 0;
    for (const member of node.members) {
      const height = yield addText2(membersGroup, member, yOffset, [member.parseClassifier()]);
    ...
    for (const method of node.methods) {
      const height = yield addText2(methodsGroup, method, methodsYOffset, [method.parseClassifier()]);
...
function addText2(_0, _1, _2) {
  return __async(this, arguments, function* (parentGroup, node, yOffset, styles = []) {
    ...
    const text2 = yield createText(textEl, sanitizeText3(decodeEntities(textContent)), {
...
function classBox(parent, node) {
  return __async(this, null, function* () {
    ...
    const {
      shapeSvg,
      bbox
    } = yield textHelper(parent, node, config, useHtmlLabels, GAP);
    const {
      labelStyles,
      nodeStyles
    } = styles2String(node);
...
function requirementBox(parent, node) {
  return __async(this, null, function* () {
    const {
      labelStyles,
      nodeStyles
    ...
    if (isRequirementNode) {
      typeHeight = yield addText3(shapeSvg, `&lt;&lt;${requirementNode.type}&gt;&gt;`, 0, node.labelStyle);
    } else {
      typeHeight = yield addText3(shapeSvg, "&lt;&lt;Element&gt;&gt;", 0, node.labelStyle);
    }
    let accumulativeHeight = typeHeight;
    const nameHeight = yield addText3(shapeSvg, requirementNode.name, accumulativeHeight, node.labelStyle + "; font-weight: bold;");
    accumulativeHeight += nameHeight + gap;
    if (isRequirementNode) {
      const idHeight = yield addText3(shapeSvg, `${requirementNode.requirementId ? `ID: ${requirementNode.requirementId}` : ""}`, accumulativeHeight, node.labelStyle);
      accumulativeHeight += idHeight;
      const textHeight = yield addText3(shapeSvg, `${requirementNode.text ? `Text: ${requirementNode.text}` : ""}`, accumulativeHeight, node.labelStyle);
      accumulativeHeight += textHeight;
      const riskHeight = yield addText3(shapeSvg, `${requirementNode.risk ? `Risk: ${requirementNode.risk}` : ""}`, accumulativeHeight, node.labelStyle);
      accumulativeHeight += riskHeight;
      yield addText3(shapeSvg, `${requirementNode.verifyMethod ? `Verification: ${requirementNode.verifyMethod}` : ""}`, accumulativeHeight, node.labelStyle);
    } else {
      const typeHeight2 = yield addText3(shapeSvg, `${elementNode.type ? `Type: ${elementNode.type}` : ""}`, accumulativeHeight, node.labelStyle);
      accumulativeHeight += typeHeight2;
      yield addText3(shapeSvg, `${elementNode.docRef ? `Doc Ref: ${elementNode.docRef}` : ""}`, accumulativeHeight, node.labelStyle);
    }
    ...
    if (accumulativeHeight > typeHeight + nameHeight + gap) {
      ...
      if (node.look === "neo") {
        ...
        const polygonPoints = [[x, lineY], [x + totalWidth, lineY], [x + totalWidth, lineY + thickness], [x, lineY + thickness]];
...
function addText3(parentGroup, inputText, yOffset, style = "") {
  return __async(this, null, function* () {
    if (inputText === "") {
      return 0;
    }
    ...
    const text2 = yield createText(textEl, sanitizeText3(decodeEntities(inputText)), {
...
function kanbanItem(_0, _1, _2) {
  return __async(this, arguments, function* (parent, kanbanNode, {
    config
  }) {
    const {
      labelStyles,
    ...
    const {
      ...
      bbox,
      label: labelElTitle
    } = yield labelHelper(parent, kanbanNode, getNodeClasses(kanbanNode));
    ...
    if (link) {
      ({
        label: labelEl,
        bbox: bbox2
      } = yield insertLabel(link, "ticket" in kanbanNode && kanbanNode.ticket || "", options));
    } else {
      ({
        label: labelEl,
        bbox: bbox2
      } = yield insertLabel(shapeSvg, "ticket" in kanbanNode && kanbanNode.ticket || "", options));
    }
    const {
      label: labelElAssigned,
      bbox: bboxAssigned
    } = yield insertLabel(shapeSvg, "assigned" in kanbanNode && kanbanNode.assigned || "", options);
...
__name(cloud, "cloud");
function defaultMindmapNode(parent, node) {
  return __async(this, null, function* () {
    const {
      labelStyles,
      nodeStyles
...
function mindmapCircle(parent, node) {
  return __async(this, null, function* () {
    const options = {
...
function insertNode(elem, node, renderOptions) {
  return __async(this, null, function* () {
    let newEl;
    let el;
    if (node.shape === "rect") {
    ...
    if (node.link) {
      ...
      el = yield shapeHandler(newEl, node, renderOptions);
    } else {
      el = yield shapeHandler(elem, node, renderOptions);
      newEl = el;
    }
...
//# sourceMappingURL=chunk-TJ2BTFMQ.mjs.map
