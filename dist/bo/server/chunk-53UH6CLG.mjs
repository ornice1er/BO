...
function longestPath(g) {
  ...
  function dfs3(v) {
    ...
    visited[v] = true;
    var rank2 = min_default(map_default(g.outEdges(v), function(e) {
...
//# sourceMappingURL=chunk-53UH6CLG.mjs.map
