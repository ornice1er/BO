...
var arrowTypesWithMarginSupport = ["cross", "point", "circle", "lollipop", "aggregation", "extension", "composition", "dependency", "barb"];
...
var insertEdgeLabel = /* @__PURE__ */ __name((elem, edge) => __async(null, null, function* () {
  ...
  if (edge.startLabelLeft) {
    ...
    const startLabelElement = yield createLabel_default(inner, edge.startLabelLeft, getLabelStyles(edge.labelStyle) || "", false, false);
  ...
  if (edge.startLabelRight) {
    ...
    const startLabelElement = yield createLabel_default(inner, edge.startLabelRight, getLabelStyles(edge.labelStyle) || "", false, false);
    fo = startLabelElement;
  ...
  if (edge.endLabelLeft) {
    ...
    const endLabelElement = yield createLabel_default(inner, edge.endLabelLeft, getLabelStyles(edge.labelStyle) || "", false, false);
    fo = endLabelElement;
  ...
  if (edge.endLabelRight) {
    ...
    const endLabelElement = yield createLabel_default(inner, edge.endLabelRight, getLabelStyles(edge.labelStyle) || "", false, false);
    fo = endLabelElement;
    let slBox = endLabelElement.getBBox();
    if (useHtmlLabels) {
      const div = endLabelElement.children[0];
...
//# sourceMappingURL=chunk-UYXUILZV.mjs.map
