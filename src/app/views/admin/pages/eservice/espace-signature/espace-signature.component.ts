...
@Component({
  ...
  templateUrl: './espace-signature.component.html',
        standalone:true,
        imports:[CommonModule,FormsModule,NgbModule,LoadingComponent,SampleSearchPipe,NgSelectModule,NgxPaginationModule,MatTooltipModule],
    
  styleUrls: ['./espace-signature.component.css']
})
export class EspaceSignatureComponent implements OnInit {
  ...
  // }
    ...
    all() {
      ...
      this.loading2=true;
      this.requeteService.getByPrestationToSign(this.prestation,this.code).subscribe((res:any)=>{
        this.data.length=0
        this.data=res
        this.loading2=false;
