    ...
    ngOnInit(): void {
      ...
      this.activatedRoute.paramMap.subscribe(params => {
        ...
        if (this.code==undefined) {
         // AlertNotif.finish('Configuration de prestation','Code prestation requis veuillez contacter l\'administrateur.')
        }else{
          this.prestationService.show(this.code).subscribe(
            (res:any)=>{
              this.activePrestation=res
      ...
      if (this.prestation == 'autorisation-de-stage' && (this.selected_data.content == null || this.selected_data.content2 == null || this.selected_data.content3 == null )) {
       ...
       if(confirm("Envoyer l'attestation au demandeur")){
          ...
          this.responseService.store({
           ...
           this.all()
            this.loading=false;
            this.toastrService.success("Présence au poste de l'agent confirmé");
