...
async delete() {
  ...
  setStatus(value:any){
    ...
    this.toastrService.warning("Opération en cours")
      this.loading=true
        this.offcerService.setStatus(this.selected_data.id,value).subscribe((res:any)=>{
 ...
 onSearchChange() {
  const localResults = this.data.filter((d:any) => d.lastname?.includes(this.search_text));
  ...
  this.offcerService.search({search:this.search_text}).subscribe({
    next: (result:any) => {
